...
float Vector3f::dot( const Vector3f& v0 ) {
	return m_elements[0] * v0[0] + m_elements[1] * v0[1] + m_elements[2] * v0[2];
}
...
Vector3f Vector3f::cross( const Vector3f& v0 ) {
	return Vector3f
	       (
	           m_elements[1] * v0.z() - m_elements[2] * v0.y(),
	           m_elements[2] * v0.x() - m_elements[0] * v0.z(),
