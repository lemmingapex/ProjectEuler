...
public class BigIntegerFraction {
	...
	public BigIntegerFraction subtract(BigIntegerFraction bigIntegerFraction) {
		return new BigIntegerFraction(this.getNumerator().multiply(bigIntegerFraction.getDenominator()).subtract(bigIntegerFraction.getNumerator().multiply(this.getDenominator())), (this.getDenominator().multiply(bigIntegerFraction.getDenominator()))).reduce();
	}

	public BigIntegerFraction multiply(BigIntegerFraction bigIntegerFraction) {
		return new BigIntegerFraction(this.getNumerator().multiply(bigIntegerFraction.getNumerator()), (this.getDenominator().multiply(bigIntegerFraction.getDenominator())));
	}
